...
class ConfigManager:
    ...
    def get_server_customized_url(self):
        return self.get_value("server/customized_url", value_type=str)

    def set_server_customized_url(self, value):
        self.set_value("server/customized_url", value)

    # 获取和保存自定义服务器端口
    def get_server_customized_port(self):
        return self.get_value("server/customized_port", value_type=str)

    def set_server_customized_port(self, value):
        self.set_value("server/customized_port", value)
